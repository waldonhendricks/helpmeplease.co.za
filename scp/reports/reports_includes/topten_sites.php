...
$query = "select `agency`,COUNT(`ticket_id`) as `counted` FROM `ost_ticket` GROUP by `agency` ORDER BY `counted` DESC LIMIT 0,10;";
...
<br>
<a href="javascript:toggleLayer('EmpForm');" title="See Data: Locations">See Raw Data: Top Ten Ticket Sites</a><br>
<div id="EmpForm">
