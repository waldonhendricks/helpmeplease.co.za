...
<html>
<head>
<title>HHI Support Report Top Ten Ticket openers</title>
...
$query = "select `email`,`name`,COUNT(`ticket_id`) as `counted` FROM `ost_ticket` GROUP by `email` ORDER BY `counted` DESC LIMIT 0,10;";
//$query = "select `email`,`name`,`counted` from reports WHERE YEAR(name)=$report_year AND `corp_name` = '".$corp_name."';";
$result=mysql_query($query);
$num = mysql_numrows($result);

//print("Incidents for $report_year at $corp_name: $num<br>");
...
<b>Top Ten Ticket Openers of All Time</b><br>
...
<br>
<a href="javascript:toggleLayer('EmpForm');" title="See Data: Locations">See Raw Data: Top Ten Ticket Openers</a><br>
<div id="EmpForm">
