...
<div class="msg">Query Type: <?=Format::htmlchars($ticket->getSubject())?></div>
<div>
    <?if($errors['err']) {?>
...
<div>
    ...
    <div id="reply" style="padding:10px 0 20px 40px;">
        <?if($ticket->isClosed()) {?>
        <div class="msg">Ticket will be reopened on message reply</div>
        <?}?>
        <form action="view.php?id=<?=$id?>#reply" name="reply" method="post" enctype="multipart/form-data">
            ...
            <div align="left"  style="padding:10px 0 10px 0;">
                <input class="button" type='submit' value='Sent Reply' />
