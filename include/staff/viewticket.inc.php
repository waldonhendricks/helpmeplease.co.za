...
<table width="100%" cellpadding="2" cellspacing="0" border="0">
    ...
    <tr><td colspan=2 class="msg">Reason for Query: <?=Format::htmlchars($ticket->getSubject())?></td></tr>
    <tr>
...
<table align="center" cellspacing="0" cellpadding="3" width="90%" border=0>
  ...
  <tr> <td align="center">
        <div class="tabber">
                         ...
                         if($appendStaffSig || $appendDeptSig) { ?>
                          <div style="margin-top: 10px;">
                               ...
                               <label> <input type="radio" name="signature" value="mine" <?=$info['signature']=='mine'?'checked':''?> > My signature</label>
                                <?}?>
                                <?if($appendDeptSig) {?>
                                <label><input type="radio" name="signature" value="dept" <?=$info['signature']=='dept'?'checked':''?> > Domain Signature</label>
                                <?}?>
                           </div>
                         <?}?>
                        <div style="margin-top: 3px;">
                            <b>Ticket Query Status:</b>
                            <?
            ...
            <div id="transfer" class="tabbertab"  align="left">
                ...
                <p>
                    ...
                    <form action="tickets.php?id=<?=$id?>#transfer" name="notes" method="post" enctype="multipart/form-data">
                        ...
                        <div>
                            <span for="dept_id">Academic Domain:</span>
                            <select id="dept_id" name="dept_id">
                                ...
                                while (list($deptId,$deptName) = db_fetch_row($depts)){
                                    ...
                                    <option value="<?=$deptId?>"<?=$selected?>><?=$deptName?> Domain </option>
                                <?
                                }?>
			...
			<div id="Refer" class="tabbertab"  align="left">
        <h2><?=$staff?'Refer Ticket':'Refer to Staff'?></h2>
       <p>
