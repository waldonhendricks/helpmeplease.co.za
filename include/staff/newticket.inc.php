...
<table width="80%" border="0" cellspacing=1 cellpadding=2>
   <form action="tickets.php" method="post" enctype="multipart/form-data">
    ...
    <tr>
        ...
        <td>
            ...
            <? if($cfg->notifyONNewStaffTicket()) {?>
               &nbsp;&nbsp;&nbsp;
               <input type="checkbox" name="alertuser" <?=(!$errors || $info['alertuser'])? 'checked': ''?>>Send email alert to CPUT Student.
            <?}?>
        </td>
    </tr>
    <tr>
        <td align="left" ><b>Full Name(s):</b></td>
        <td>
    ...
    <tr>
        <td align="left"><b>Academic Domain:</b></td>
        <td>
            <select name="deptId">
    ...
    <tr>
        <td align="left"><b>Query Reason:</b></td>
        <td>
    ...
    <tr>
        <td align="left" valign="top"><b>Query message:</b></td>
        <td>
    ...
    <tr>
        <td align="left" valign="top">Query Type:</td>
        <td>
            <select name="topicId">
    ...
    <tr>
        ...
        <td>
            <select id="staffId" name="staffId">
                ...
                &nbsp;&nbsp;&nbsp;
                <input type="checkbox" name="alertstaff" <?=(!$errors || $info['alertstaff'])? 'checked': ''?>>Send alert email to assigned staff.
        </td>
    </tr>
    <tr>
        <td>Signature:</td>
        <td> <?php
            ...
            <div style="margin-top: 2px;">
                ...
                <?if($appendStaffSig) {?>
                 ...
                 <?}?>
                 <label><input type="radio" name="signature" value="dept" <?=$info['signature']=='dept'?'checked':''?> > Domain Signature (if any)</label>
            </div>
        </td>
    </tr>
    <tr height=2px><td align="left" colspan=2 >&nbsp;</td</tr>
