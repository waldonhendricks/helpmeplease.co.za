...
if($_POST && $errors){
    ...
    $info=array('email'=>$ticket->getEmail(),
	            'student_number'=>$ticket->getstudent(), //CPUT student number fetch
                'name' =>$ticket->getName(),
...
<table width="100%" border="0" cellspacing=1 cellpadding=2>
  <form action="tickets.php?id=<?=$ticket->getId()?>" method="post">
	...
	<tr>
         <td align="left">CPUT Student Number:</td>
<td>
          <input type="text" size ="9" name="student_number" value="<?php echo $info['student_number'];?>">
           &nbsp;<span class="error">*&nbsp; <?php echo $errors[ 'student_number'];?></span>
</td>
</tr>
    <tr>
